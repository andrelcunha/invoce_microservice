...
public class PortalCredentialsController : ControllerBase
{
    ...
    private readonly IValidator<CreatePortalCredentialsDto> _createValidator;
    ...
    public PortalCredentialsController(
        ...
        IValidator<CreatePortalCredentialsDto> createValidator,
    ...
    public async Task<IActionResult> Create([FromForm] CreatePortalCredentialsDto dto, [FromForm] UploadCertificateForm certificate)
    {
        ...
        var existing = await _repository.GetByIssuerCnpjAsync(dto.IssuerCnpj);
        if (existing != null)
